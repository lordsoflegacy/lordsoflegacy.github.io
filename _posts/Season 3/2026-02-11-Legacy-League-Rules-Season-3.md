...
To avoid any unpleasantness related to potential ambiguities during Legacy League matches, the following rules have been written down and adopted for the third season of the Legacy League.
...
The second season starts with the publication of [Banned and Restricted Announcement on 09.02.2026](https://magic.wizards.com/en/news/announcements/banned-and-restricted-february-9-2026). The planned end of the season is TBD.
...
The _start of the round_ is defined as the moment when the pairings are posted.
...
For each FNM, _store credit_ is distributed among the top players. The majority of the winnings goes to the player that finished in the first place, while the remaining pool is shared among other players who scored at least $$ \mathbf{X}-1 $$.

This, of course, assumes 4-round FNMs.

Draws are treated like losses, unless this concerns only the player who finished first without any tiebreakers. If such treatment demotes the top players who are tied in the first place, they are treated as if they scored $$ \mathbf{X}-1 $$[^ex1][^ex2][^ex3].
